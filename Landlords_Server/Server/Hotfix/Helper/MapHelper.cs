...
namespace ETHotfix
{
    ...
    public static class CardHelper
    {
        ...
        public static bool IsStraight(Card[] cards)
        {
            ...
            {
                int w = cards[i].CardWeight;
                if (w - cards[i + 1].CardWeight != 1)
                    return false;

                //不能超过A
                if (w > (int)Weight.One || cards[i + 1].CardWeight > (int)Weight.One)
                    return false;
            }
        ...
        public static bool IsDoubleStraight(Card[] cards)
        {
            ...
            for (int i = 0; i < cards.Length; i += 2)
            {
                ...
                if (i < cards.Length - 2)
                {
                    ...
                    //不能超过A
                    if (cards[i].CardWeight > (int)Weight.One || cards[i + 2].CardWeight > (int)Weight.One)
                        return false;
                }
            }
        ...
        public static bool IsTripleStraight(Card[] cards)
        {
            ...
            for (int i = 0; i < cards.Length; i += 3)
            {
                ...
                if (i < cards.Length - 3)
                {
                    ...
                    //不能超过A
                    if (cards[i].CardWeight > (int)Weight.One || cards[i + 3].CardWeight > (int)Weight.One)
                        return false;
                }
            }
        ...
        public static bool IsJokerBoom(Card[] cards)
        {
            if (cards.Length != 2)
                return false;
            if (cards[0].CardWeight == (int)Weight.SJoker)
            {
                if (cards[1].CardWeight == (int)Weight.LJoker)
                    return true;
                return false;
            }
            else if (cards[0].CardWeight == (int)Weight.LJoker)
            {
                if (cards[1].CardWeight == (int)Weight.SJoker)
                    return true;
                return false;
            }
